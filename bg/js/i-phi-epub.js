...
(async () => {
  ...
  const CONFIG = {
    ...
    coverImageUrl:   'https://gmodebate.github.io/cosmos/i/b/information-philosopher/cover-bg_BG.jpg',
    ...
    epubTitle:       'Информационен философ — Пълно ръководство',
    epubAuthor:      'Bob Doyle',
    epubPublisher:   'InformationPhilosopher.com (epub by gmodebate.github.io)',
    epubDescription: 'Пълно офлайн издание на InformationPhilosopher.com в EPUB формат.',
