...
(async () => {
  ...
  const CONFIG = {
    ...
    coverImageUrl:   'https://gmodebate.github.io/cosmos/i/b/information-philosopher/cover-pa_IN.jpg',
    ...
    epubTitle:       'ਸੂਚਨਾ ਦਾਰਸ਼ਨਿਕ — ਸੰਪੂਰਨ ਸਰੋਤ',
    epubAuthor:      'Bob Doyle',
    epubPublisher:   'InformationPhilosopher.com (epub by gmodebate.github.io)',
    epubDescription: 'InformationPhilosopher.com ਦਾ ਇੱਕ ਸੰਪੂਰਨ ਆਫਲਾਈਨ EPUB ਸੰਸਕਰਣ।',
