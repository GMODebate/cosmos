...
(async () => {
  ...
  const CONFIG = {
    ...
    coverImageUrl:   'https://gmodebate.github.io/cosmos/i/b/information-philosopher/cover-ko_KR.jpg',
    ...
    epubTitle:       '인포메이션 필로소퍼 — 완전한 자료집',
    epubAuthor:      'Bob Doyle',
    epubPublisher:   'InformationPhilosopher.com (epub by gmodebate.github.io)',
    epubDescription: 'InformationPhilosopher.com의 완전한 오프라인 EPUB 에디션.',
