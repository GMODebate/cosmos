...
(async () => {
  ...
  const CONFIG = {
    ...
    coverImageUrl:   'https://gmodebate.github.io/cosmos/i/b/information-philosopher/cover-ar_SA.jpg',
    ...
    epubTitle:       'الفيلسوف المعلوماتي — مصدر شامل',
    epubAuthor:      'Bob Doyle',
    epubPublisher:   'InformationPhilosopher.com (epub by gmodebate.github.io)',
    epubDescription: 'طبعة EPUB كاملة غير متصلة بالإنترنت من موقع InformationPhilosopher.com.',
