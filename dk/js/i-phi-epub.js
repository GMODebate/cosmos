...
(async () => {
  ...
  const CONFIG = {
    ...
    coverImageUrl:   'https://gmodebate.github.io/cosmos/i/b/information-philosopher/cover-da_DK.jpg',
    ...
    epubTitle:       'Information Philosopher — Komplet Ressource',
    epubAuthor:      'Bob Doyle',
    epubPublisher:   'InformationPhilosopher.com (epub by gmodebate.github.io)',
    epubDescription: 'En komplet offline EPUB-udgave af InformationPhilosopher.com.',
