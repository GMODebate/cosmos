...
(async () => {
  ...
  const CONFIG = {
    ...
    coverImageUrl:   'https://gmodebate.github.io/cosmos/i/b/information-philosopher/cover-vi_VN.jpg',
    ...
    epubTitle:       'Information Philosopher — Tài Nguyên Toàn Tập',
    epubAuthor:      'Bob Doyle',
    epubPublisher:   'InformationPhilosopher.com (epub by gmodebate.github.io)',
    epubDescription: 'Ấn bản EPUB ngoại tuyến toàn bộ của InformationPhilosopher.com.',
