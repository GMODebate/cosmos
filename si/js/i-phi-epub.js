...
(async () => {
  ...
  const CONFIG = {
    ...
    coverImageUrl:   'https://gmodebate.github.io/cosmos/i/b/information-philosopher/cover-sl_SI.jpg',
    ...
    epubTitle:       'Informacijski filozof — Popoln vir',
    epubAuthor:      'Bob Doyle',
    epubPublisher:   'InformationPhilosopher.com (epub by gmodebate.github.io)',
    epubDescription: 'Popolna izdaja EPUB brez povezave za InformationPhilosopher.com.',
