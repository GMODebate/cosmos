...
(async () => {
  ...
  const CONFIG = {
    ...
    coverImageUrl:   'https://gmodebate.github.io/cosmos/i/b/information-philosopher/cover-cs_CZ.jpg',
    ...
    epubTitle:       'Informační filosof — Kompletní zdroj',
    epubAuthor:      'Bob Doyle',
    epubPublisher:   'InformationPhilosopher.com (epub by gmodebate.github.io)',
    epubDescription: 'Kompletní offline EPUB edice webu InformationPhilosopher.com.',
