...
(async () => {
  ...
  const CONFIG = {
    ...
    coverImageUrl:   'https://gmodebate.github.io/cosmos/i/b/information-philosopher/cover-fa_IR.jpg',
    ...
    epubTitle:       'فیلوزوف اطلاعات — منبع جامع',
    epubAuthor:      'Bob Doyle',
    epubPublisher:   'InformationPhilosopher.com (epub by gmodebate.github.io)',
    epubDescription: 'نسخهٔ EPUB کامل و آفلاین از InformationPhilosopher.com',
