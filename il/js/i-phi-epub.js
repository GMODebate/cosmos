...
(async () => {
  ...
  const CONFIG = {
    ...
    coverImageUrl:   'https://gmodebate.github.io/cosmos/i/b/information-philosopher/cover-he_IL.jpg',
    ...
    epubTitle:       'Information Philosopher — משאב שלם',
    epubAuthor:      'Bob Doyle',
    epubPublisher:   'InformationPhilosopher.com (epub by gmodebate.github.io)',
    epubDescription: 'מהדורת EPUB שלמה לא מקוונת של InformationPhilosopher.com.',
