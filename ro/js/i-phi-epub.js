...
(async () => {
  ...
  const CONFIG = {
    ...
    coverImageUrl:   'https://gmodebate.github.io/cosmos/i/b/information-philosopher/cover-ro_RO.jpg',
    ...
    epubTitle:       'Filosof al Informației — Resursă Completă',
    epubAuthor:      'Bob Doyle',
    epubPublisher:   'InformationPhilosopher.com (epub by gmodebate.github.io)',
    epubDescription: 'O ediție EPUB offline completă a InformationPhilosopher.com.',
