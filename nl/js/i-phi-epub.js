...
(async () => {
  ...
  const CONFIG = {
    ...
    coverImageUrl:   'https://gmodebate.github.io/cosmos/i/b/information-philosopher/cover-nl_NL.jpg',
    ...
    epubTitle:       'Informatiefilosoof — Compleet Naslagwerk',
    epubAuthor:      'Bob Doyle',
    epubPublisher:   'InformationPhilosopher.com (epub by gmodebate.github.io)',
    epubDescription: 'Een volledige offline EPUB-editie van InformationPhilosopher.com.',
