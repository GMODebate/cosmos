...
(async () => {
  ...
  const CONFIG = {
    ...
    coverImageUrl:   'https://gmodebate.github.io/cosmos/i/b/information-philosopher/cover-sk_SK.jpg',
    ...
    epubTitle:       'Informačný filozof — Kompletný zdroj',
    epubAuthor:      'Bob Doyle',
    epubPublisher:   'InformationPhilosopher.com (epub by gmodebate.github.io)',
    epubDescription: 'Kompletná offline EPUB edícia stránky InformationPhilosopher.com.',
