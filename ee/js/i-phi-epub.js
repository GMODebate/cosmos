...
(async () => {
  ...
  const CONFIG = {
    ...
    coverImageUrl:   'https://gmodebate.github.io/cosmos/i/b/information-philosopher/cover-et_EE.jpg',
    ...
    epubTitle:       'Infofilosoof — Täielik ressurss',
    epubAuthor:      'Bob Doyle',
    epubPublisher:   'InformationPhilosopher.com (epub by gmodebate.github.io)',
    epubDescription: 'Täielik võrguühenduseta InformationPhilosopher.com EPUB-väljaanne.',
