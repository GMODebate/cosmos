...
(async () => {
  ...
  const CONFIG = {
    ...
    coverImageUrl:   'https://gmodebate.github.io/cosmos/i/b/information-philosopher/cover-el_GR.jpg',
    ...
    epubTitle:       'Φιλόσοφος της Πληροφορίας — Πλήρες Αναφοράριο',
    epubAuthor:      'Bob Doyle',
    epubPublisher:   'InformationPhilosopher.com (epub by gmodebate.github.io)',
    epubDescription: 'Μια πλήρης εκτός σύνδεσης έκδοση EPUB του InformationPhilosopher.com.',
