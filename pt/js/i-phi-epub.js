...
(async () => {
  ...
  const CONFIG = {
    ...
    coverImageUrl:   'https://gmodebate.github.io/cosmos/i/b/information-philosopher/cover-pt_PT.jpg',
    ...
    epubTitle:       'Filosofo da Informação — Recurso Completo',
    epubAuthor:      'Bob Doyle',
    epubPublisher:   'InformationPhilosopher.com (epub by gmodebate.github.io)',
    epubDescription: 'Uma edição EPUB offline completa de InformationPhilosopher.com.',
