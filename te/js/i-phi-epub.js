...
(async () => {
  ...
  const CONFIG = {
    ...
    coverImageUrl:   'https://gmodebate.github.io/cosmos/i/b/information-philosopher/cover-te_IN.jpg',
    ...
    epubTitle:       'సమాచార తత్త్వవేత్త — సంపూర్ణ వనరు',
    epubAuthor:      'Bob Doyle',
    epubPublisher:   'InformationPhilosopher.com (epub by gmodebate.github.io)',
    epubDescription: 'InformationPhilosopher.com యొక్క పూర్తి ఆఫ్‌లైన్ EPUB ఎడిషన్.',
