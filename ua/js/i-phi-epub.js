...
(async () => {
  ...
  const CONFIG = {
    ...
    coverImageUrl:   'https://gmodebate.github.io/cosmos/i/b/information-philosopher/cover-uk_UA.jpg',
    ...
    epubTitle:       'Інформаційний філософ — Повне джерело',
    epubAuthor:      'Bob Doyle',
    epubPublisher:   'InformationPhilosopher.com (epub by gmodebate.github.io)',
    epubDescription: 'Повне офлайн-видання сайту InformationPhilosopher.com у форматі EPUB.',
