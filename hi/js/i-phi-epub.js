...
(async () => {
  ...
  const CONFIG = {
    ...
    coverImageUrl:   'https://gmodebate.github.io/cosmos/i/b/information-philosopher/cover-hi_IN.jpg',
    ...
    epubTitle:       'सूचना दार्शनिक — संपूर्ण संसाधन',
    epubAuthor:      'Bob Doyle',
    epubPublisher:   'InformationPhilosopher.com (epub by gmodebate.github.io)',
    epubDescription: 'InformationPhilosopher.com का एक पूर्ण ऑफ़लाइन EPUB संस्करण।',
