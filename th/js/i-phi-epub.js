...
(async () => {
  ...
  const CONFIG = {
    ...
    coverImageUrl:   'https://gmodebate.github.io/cosmos/i/b/information-philosopher/cover-th_TH.jpg',
    ...
    epubTitle:       'Information Philosopher — แหล่งข้อมูลสมบูรณ์แบบ',
    epubAuthor:      'Bob Doyle',
    epubPublisher:   'InformationPhilosopher.com (epub by gmodebate.github.io)',
    epubDescription: 'ฉบับ EPUB แบบออฟไลน์สมบูรณ์ของ InformationPhilosopher.com',
