...
(async () => {
  ...
  const CONFIG = {
    ...
    coverImageUrl:   'https://gmodebate.github.io/cosmos/i/b/information-philosopher/cover-si_LK.jpg',
    ...
    epubTitle:       'තොරතුරු දාර්ශනික — සම්පූර්ණ සම්පත්',
    epubAuthor:      'Bob Doyle',
    epubPublisher:   'InformationPhilosopher.com (epub by gmodebate.github.io)',
    epubDescription: 'InformationPhilosopher.com හි බාගත කළ හැකි සම්පූර්ණ EPUB සංස්කරණය.',
