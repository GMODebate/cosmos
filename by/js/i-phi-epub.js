...
(async () => {
  ...
  const CONFIG = {
    ...
    coverImageUrl:   'https://gmodebate.github.io/cosmos/i/b/information-philosopher/cover-be_BY.jpg',
    ...
    epubTitle:       'Інфармацыйны філосаф — Поўны рэсурс',
    epubAuthor:      'Bob Doyle',
    epubPublisher:   'InformationPhilosopher.com (epub by gmodebate.github.io)',
    epubDescription: 'Поўная афлайн EPUB-версія сайта InformationPhilosopher.com.',
