...
(async () => {
  ...
  const CONFIG = {
    ...
    coverImageUrl:   'https://gmodebate.github.io/cosmos/i/b/information-philosopher/cover-fr_FR.jpg',
    ...
    epubTitle:       'Philosophe de l\'Information — Ressource Complète',
    epubAuthor:      'Bob Doyle',
    epubPublisher:   'InformationPhilosopher.com (epub by gmodebate.github.io)',
    epubDescription: 'Une édition EPUB complète hors ligne de InformationPhilosopher.com.',
