...
(async () => {
  ...
  const CONFIG = {
    ...
    coverImageUrl:   'https://gmodebate.github.io/cosmos/i/b/information-philosopher/cover-ka_GE.jpg',
    ...
    epubTitle:       'ინფორმაციის ფილოსოფოსი — სრული რესურსი',
    epubAuthor:      'Bob Doyle',
    epubPublisher:   'InformationPhilosopher.com (epub by gmodebate.github.io)',
    epubDescription: 'InformationPhilosopher.com-ის სრული ოფლაინ EPUB გამოცემა.',
