...
(async () => {
  ...
  const CONFIG = {
    ...
    coverImageUrl:   'https://gmodebate.github.io/cosmos/i/b/information-philosopher/cover-ms_MY.jpg',
    ...
    epubTitle:       'Falsafah Maklumat — Sumber Lengkap',
    epubAuthor:      'Bob Doyle',
    epubPublisher:   'InformationPhilosopher.com (epub by gmodebate.github.io)',
    epubDescription: 'Edisi EPUB luar talian lengkap bagi InformationPhilosopher.com.',
