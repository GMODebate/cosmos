...
(async () => {
  ...
  const CONFIG = {
    ...
    coverImageUrl:   'https://gmodebate.github.io/cosmos/i/b/information-philosopher/cover-hr_HR.jpg',
    ...
    epubTitle:       'Informacijski filozof — Potpuni resurs',
    epubAuthor:      'Bob Doyle',
    epubPublisher:   'InformationPhilosopher.com (epub by gmodebate.github.io)',
    epubDescription: 'Potpuno offline EPUB izdanje stranice InformationPhilosopher.com.',
