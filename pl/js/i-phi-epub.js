...
(async () => {
  ...
  const CONFIG = {
    ...
    coverImageUrl:   'https://gmodebate.github.io/cosmos/i/b/information-philosopher/cover-pl_PL.jpg',
    ...
    epubTitle:       'Informacyjny Filozof — Kompletne Źródło Wiedzy',
    epubAuthor:      'Bob Doyle',
    epubPublisher:   'InformationPhilosopher.com (epub by gmodebate.github.io)',
    epubDescription: 'Pełna offline\'owa edycja EPUB serwisu InformationPhilosopher.com.',
