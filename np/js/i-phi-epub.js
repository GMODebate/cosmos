...
(async () => {
  ...
  const CONFIG = {
    ...
    coverImageUrl:   'https://gmodebate.github.io/cosmos/i/b/information-philosopher/cover-ne_NP.jpg',
    ...
    epubTitle:       'सूचना दार्शनिक — पूर्ण स्रोत',
    epubAuthor:      'Bob Doyle',
    epubPublisher:   'InformationPhilosopher.com (epub by gmodebate.github.io)',
    epubDescription: 'InformationPhilosopher.com को पूर्ण अफलाइन EPUB संस्करण।',
