...
(async () => {
  ...
  const CONFIG = {
    ...
    coverImageUrl:   'https://gmodebate.github.io/cosmos/i/b/information-philosopher/cover-bn_BD.jpg',
    ...
    epubTitle:       'তথ্য দার্শনিক — সম্পূর্ণ তথ্যভাণ্ডার',
    epubAuthor:      'Bob Doyle',
    epubPublisher:   'InformationPhilosopher.com (epub by gmodebate.github.io)',
    epubDescription: 'InformationPhilosopher.com-এর একটি সম্পূর্ণ অফলাইন EPUB সংস্করণ।',
