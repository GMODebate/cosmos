...
(async () => {
  ...
  const CONFIG = {
    ...
    coverImageUrl:   'https://gmodebate.github.io/cosmos/i/b/information-philosopher/cover-ur_PK.jpg',
    ...
    epubTitle:       'انفارمیشن فلاسفر — مکمل ذخیرہ',
    epubAuthor:      'Bob Doyle',
    epubPublisher:   'InformationPhilosopher.com (epub by gmodebate.github.io)',
    epubDescription: 'InformationPhilosopher.com کا ایک مکمل آف لائن EPUB ایڈیشن',
