...
(async () => {
  ...
  const CONFIG = {
    ...
    coverImageUrl:   'https://gmodebate.github.io/cosmos/i/b/information-philosopher/cover-sr_RS.jpg',
    ...
    epubTitle:       'Informacioni filozof — Kompletan resurs',
    epubAuthor:      'Bob Doyle',
    epubPublisher:   'InformationPhilosopher.com (epub by gmodebate.github.io)',
    epubDescription: 'Kompletno offline EPUB izdanje sajta InformationPhilosopher.com.',
